/**
@author LNazarenko
This trigger WonGames counts the rating of winners and writes a value of field Place_in_the_rating__c
*/

trigger WonGames on Unit__c (before update) {
       ...
       public void BubbleSort(Unit__c[] inArray) {
